...
for img_file in my_pic :
    if img_file.split(".")[-1].lower() in {"jpeg", "jpg", "png"}:
        ...
        Green_class[0].extend(R.tolist())
        Green_class[1].extend(G.tolist())
        Green_class[2].extend(B.tolist())



my_greenclass = open('greenclass.pkl','wb')
pickle.dump(Green_class,my_greenclass)
my_greenclass.close()
